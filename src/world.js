...
export class World {
  ...
  _applyEvents(triggeredObservers=new Set()) {
    ...
    this._events.forEach((event) => {
      const observerOldValues = this._observers.map((o) => o.examine(this._model));

      this._model.assert(event);

      const observerEffects = this._observers.map((o, i) => {
        const effect = o.consider(this, this._model, observerOldValues[i]);
